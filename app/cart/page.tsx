  ...
  if (items.length === 0) {
    return (
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 pt-28 pb-16 flex flex-col items-center text-center">
        <div className="w-24 h-24 bg-[#141414] border border-white/10 rounded-2xl flex items-center justify-center mb-6">
      ...
      <div className="grid lg:grid-cols-3 gap-6">
        <div className="lg:col-span-2 space-y-3">
          {items.map(({ product, quantity }) => {
            ...
            return (
              <div key={product.id}
                className="flex gap-4 bg-[#141414] border border-white/10 rounded-xl p-4 hover:border-white/20 transition-colors">
                <Link href={href}
                  className="w-20 h-20 shrink-0 bg-[#1C1C1C] rounded-xl flex items-center justify-center cursor-pointer hover:opacity-80 transition-opacity">
                ...
                <div className="flex-1 min-w-0">
                  ...
                  <div className="flex items-center justify-between mt-3">
                    <div className="flex items-center gap-1 bg-[#0A0A0A] rounded-lg border border-white/10">
        ...
        <div className="lg:col-span-1">
          <div className="bg-[#141414] border border-white/10 rounded-xl p-5 sticky top-24">
