...
import { Smartphone, Phone, Mail, MapPin, Clock, Send, Shield, Award, Users, Wrench } from "lucide-react";
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10">
          ...
          <div>
            ...
            <a href="https://yandex.uz/maps/?pt=69.279737,41.299496&z=15&l=map" target="_blank" rel="noopener noreferrer"
              className="inline-flex items-center gap-1.5 mt-3 text-xs text-[#EF4444] hover:text-[#F87171] transition-colors cursor-pointer">
